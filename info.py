...
API_ID = int(environ.get('API_ID', '25778452'))
API_HASH = environ.get('API_HASH', 'c6fa8495c539afc7a47d040aede6ff54')
BOT_TOKEN = environ.get('BOT_TOKEN', "7127385668:AAFTGJpcNCbMiAiyCS9LlEqQdTgBCmUU8T4")
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6656608288').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002028420688').split()]
...
auth_channel = environ.get('AUTH_CHANNEL', '-1001643592704')
auth_grp = environ.get('AUTH_GROUP')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', '')
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002028420688')
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None
NO_RESULTS_MSG = bool(environ.get("NO_RESULTS_MSG", False))

# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://SweetToxicMovie:SweetToxicMovie@sweettoxicmovie.10y1mrr.mongodb.net/?retryWrites=true&w=majority&appName=SweetToxicMovie")
DATABASE_NAME = environ.get('DATABASE_NAME', "sweettoxicmovie")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')

# Others
VERIFY = bool(environ.get('VERIFY', False))
SHORTLINK_URL = environ.get('SHORTLINK_URL', 'ziplinker.net')
SHORTLINK_API = environ.get('SHORTLINK_API', '2d748c9946aa1c9a5fcc0b93bdd8d8fa453b30ab')
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002138320657'))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'SweetToxicMovie')
